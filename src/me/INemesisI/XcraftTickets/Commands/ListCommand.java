	...
	protected void execute(CommandSender sender, String Command, List<String> list) {
		...
		for(Ticket ticket : tickets) {
			if (ticket.getOwner().equals(sender.getName()) || 
					(senderHasPermission("List.Other") && ticket.getAssignee().equals("none") || 
							ticket.getAssignee().equals(sender.getName()) || 
							( ticket.getAssignee().startsWith("g:") && plugin.getPermission().playerInGroup((String) null, sender.getName(), ticket.getAssignee().replace("g:", ""))) ||
